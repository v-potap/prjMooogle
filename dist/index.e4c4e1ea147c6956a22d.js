...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"posts__link\" data-id="
    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
    + " data-title="
    + alias4(((helper = (helper = helpers.title || (depth0 != null ? depth0.title : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"title","hash":{},"data":data}) : helper)))
    + ">\r\n  <a class=\"posts-block\" href=\"./details.html\">\r\n"
    ...
    + "      <div class=\"posts-block__text\">\r\n        <p>"
    + alias4(((helper = (helper = helpers.title || (depth0 != null ? depth0.title : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"title","hash":{},"data":data}) : helper)))
    + alias4(((helper = (helper = helpers.name || (depth0 != null ? depth0.name : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"name","hash":{},"data":data}) : helper)))
    + "</p>\r\n      </div>\r\n    </a>\r\n      <div class=\"posts-block__button\">\r\n"
    + ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.fav : depth0),{"name":"if","hash":{},"fn":container.program(6, data, 0),"inverse":container.program(8, data, 0),"data":data})) != null ? stack1 : "")
    + "          <svg>\r\n            <use class=\"posts-block__star\" href=\"img/sprite.svg#star-full\"></use>\r\n          </svg>\r\n        </div>\r\n        <div class=\"posts-block__button2\">\r\n          <svg>\r\n            <use href=\"img/sprite.svg#bell\"></use>\r\n          </svg>\r\n        </div>\r\n      </div>\r\n  </div>\r\n";
},"2":function(container,depth0,helpers,partials,data) {
    var helper;

  return "      <img class=\"posts__image\" src=\"https://image.tmdb.org/t/p/w500"
    ...
    return "      <img class=\"posts__image\" src=\"img/no-image.png\" alt=\"\">\r\n";
},"6":function(container,depth0,helpers,partials,data) {
    var helper;

  return "          <div data-id="
    + container.escapeExpression(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"id","hash":{},"data":data}) : helper)))
    + " class=\"posts-block__button1 button_color\">\r\n";
},"8":function(container,depth0,helpers,partials,data) {
    var helper;

  return "          <div data-id="
    + container.escapeExpression(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"id","hash":{},"data":data}) : helper)))
    + " class=\"posts-block__button1\">\r\n";
...
/* harmony import */ var _scss_main_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(23);
/* harmony import */ var _scss_main_scss__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_scss_main_scss__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(31);
...
/* harmony import */ var _list_hbs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(24);
/* harmony import */ var _list_hbs__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_list_hbs__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _js_api_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(1);
...
console.log("movieDBService :", _js_api_service__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"]);
const startStorage = document.querySelector(`#radio-${localStorage.getItem("activeFavorities")}`);
...
function handleSortClick(e) {
  if (e.target.tagName === "INPUT") {
    ...
    _js_api_service__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"].setPage(1);
    _js_api_service__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"].setSortBy(e.target.value);
    showInfo();
  }
}

function handleLoadMoreClick() {
  _js_api_service__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"].setPage(_js_api_service__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"].page + 1);
  showInfo();
}
...
function handleStorageClick(e) {
  if (e.target.tagName === "INPUT") {
    ...
    if (currentStorage === "favorities") {
      ...
      _js_api_service__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"].setStorage(currentStorage);
      _js_api_service__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"].setPage(1);
      showInfo();
    }
  }
...
function handlePostClick(event) {
  ...
  if (buttonfavourite) {
    ...
    if (clickedMovie && !favoriteMovies.find(movie => movie.id === clickedMovie)) {
      favoriteMovies.push(filmsData.find(el => +id === el.id));
      buttonfavourite.classList.add("button_color");
    } else {
      favoriteMovies = favoriteMovies.filter(el => el.id !== (clickedMovie || +id));
      buttonfavourite.classList.remove("button_color");

      if (localStorage.getItem("activeFavorities", "favorities") === "favorities") {
        blockLink.remove(); // console.log(localStorage.getItem("activeFavorities", "favorities"));
      }
    }
...
async function showInfo() {
  ...
  if (query !== null && query !== "null") {
    _js_api_service__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"].setQuery(query);
  }

  const data = await _js_api_service__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"].getInfo();
  ...
  posts.insertAdjacentHTML("beforeend", _list_hbs__WEBPACK_IMPORTED_MODULE_2___default()(newData));
  filmsData = newData;
}

function showFavoritiesInfo() {
  const localFavorities = JSON.parse(localStorage.getItem("favoriteMovies"));
  let blockFavorities = _list_hbs__WEBPACK_IMPORTED_MODULE_2___default()(localFavorities);
...
/***/ })
/******/ ]);
//# sourceMappingURL=index.e4c4e1ea147c6956a22d.js.map