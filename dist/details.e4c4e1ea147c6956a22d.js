...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"actor-item\">\r\n"
    + ((stack1 = helpers["if"].call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.profile_path : depth0),{"name":"if","hash":{},"fn":container.program(2, data, 0),"inverse":container.program(4, data, 0),"data":data})) != null ? stack1 : "")
    + "  <p class=\"actor-item__name\">"
    + container.escapeExpression(container.lambda((depth0 != null ? depth0.name : depth0), depth0))
    + "</p>\r\n</div>\r\n";
},"2":function(container,depth0,helpers,partials,data) {
    return "    <img class=\"actor-item__image\" src=\"https://image.tmdb.org/t/p/original"
    + container.escapeExpression(container.lambda((depth0 != null ? depth0.profile_path : depth0), depth0))
    + "\" alt=\"\">\r\n";
},"4":function(container,depth0,helpers,partials,data) {
    return "    <img class=\"actor-item__image\" src=\"img/no-image.png\" alt=\"\">\r\n";
...
function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
    return "<div class=\"film-image-item\">\r\n  <img class=\"film-image-item__image\" src=\"https://image.tmdb.org/t/p/w500"
    + container.escapeExpression(container.lambda((depth0 != null ? depth0.file_path : depth0), depth0))
    + "\" alt=\"\">\r\n</div>\r\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    var stack1;
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<li class=\"reviews__article\">\r\n  <img class=\"review-picture\" src=\"img/default-profile.png\" alt=\"\">\r\n  <div class=\"review-container\">\r\n    <div class=\"review-sub-container\">\r\n      <p class=\"review-name\">"
...
/* harmony import */ var slick_carousel__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(33);
/* harmony import */ var slick_carousel__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(slick_carousel__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var slick_carousel_slick_slick_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(34);
...
/* harmony import */ var slick_carousel_slick_slick_theme_scss__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(35);
...
/* harmony import */ var _scss_main_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(23);
...
/* harmony import */ var _page_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(36);
...
/* harmony import */ var _templates_actors_hbs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(25);
/* harmony import */ var _templates_actors_hbs__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_templates_actors_hbs__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var _templates_pictures_hbs__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(26);
/* harmony import */ var _templates_pictures_hbs__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_templates_pictures_hbs__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var _templates_reviews_hbs__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(27);
/* harmony import */ var _templates_reviews_hbs__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(_templates_reviews_hbs__WEBPACK_IMPORTED_MODULE_8__);
...
function getPeopleInfo() {
  ...
  .then(response => response.json()).then(data => {
    console.log(data); // FILM DIRECTOR NAME
    ...
    document.querySelector('.film-director').textContent = directors; // FILM SCREENPLAY NAME
    ...
    document.querySelector('.film-script').textContent = authors; // ACTORS SLIDER

    console.log('data-- :', data);
    const actorsSlider = document.querySelector('.slider-actors'); // console.log('actorTemplate :', actorTemplate(data.cast));

    actorsSlider.insertAdjacentHTML('beforeend', _templates_actors_hbs__WEBPACK_IMPORTED_MODULE_6___default()(data.cast)); // SLICK ACTORS SLIDER

    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.slider-actors').slick({
      slidesToShow: 4,
      slidesToScroll: 1,
...
function getMoviePictures() {
  return fetch(`${movieDB}movie/${localId}/images?api_key=${apiKey}`).then(response => response.json()).then(data => {
    console.log('data-backdrops:', data);
    const picturesSlider = document.querySelector('.slider-pictures');
    console.log(picturesSlider); // console.log('pictureTemplate(data.backdrops) :', pictureTemplate(data.backdrops));

    picturesSlider.insertAdjacentHTML('beforeend', _templates_pictures_hbs__WEBPACK_IMPORTED_MODULE_7___default()(data.backdrops)); // SLICK PICTURES SLIDER

    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.slider-pictures').slick({
      infinite: true,
      slidesToShow: 4,
      slidesToScroll: 1
    });
...
function getMovieReviews() {
  ...
  .then(response => response.json()).then(data => {
    ...
    reviewsList.insertAdjacentHTML('beforeend', _templates_reviews_hbs__WEBPACK_IMPORTED_MODULE_8___default()(data.results));
...
function getSeriesPeopleInfo() {
  ...
  .then(response => response.json()).then(data => {
    console.log('data-credits :', data); // ACTORS SLIDER
...
function getSeriesPictures() {
  return fetch(`${movieDB}${whichOne}/${localId}/images?api_key=${apiKey}`).then(response => response.json()).then(data => {
    console.log('data-backdrops:', data);
    const picturesSlider = document.querySelector('.slider-pictures');
    console.log(picturesSlider); // console.log('pictureTemplate(data.backdrops) :', pictureTemplate(data.backdrops));
...
/***/ })
/******/ ]);
//# sourceMappingURL=details.e4c4e1ea147c6956a22d.js.map